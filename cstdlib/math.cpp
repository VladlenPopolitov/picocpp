...
{
    ReturnValue->Val->FP = frexp(Param[0]->Val->FP, Param[1]->Val->PointerInt);
}
...
{
    ReturnValue->Val->FP = modf(Param[0]->Val->FP, Param[0]->Val->PointerDouble);
}
...
{
     pc->VariableDefinePlatformVar( NULL, "M_E", &pc->FPType, (UnionAnyValuePointer )&M_EValue, FALSE);
	 pc->VariableDefinePlatformVar(NULL, "M_LOG2E", &pc->FPType, (UnionAnyValuePointer )&M_LOG2EValue, FALSE);
	 pc->VariableDefinePlatformVar(NULL, "M_LOG10E", &pc->FPType, (UnionAnyValuePointer )&M_LOG10EValue, FALSE);
	 pc->VariableDefinePlatformVar(NULL, "M_LN2", &pc->FPType, (UnionAnyValuePointer )&M_LN2Value, FALSE);
	 pc->VariableDefinePlatformVar(NULL, "M_LN10", &pc->FPType, (UnionAnyValuePointer )&M_LN10Value, FALSE);
	 pc->VariableDefinePlatformVar(NULL, "M_PI", &pc->FPType, (UnionAnyValuePointer )&M_PIValue, FALSE);
	 pc->VariableDefinePlatformVar(NULL, "M_PI_2", &pc->FPType, (UnionAnyValuePointer )&M_PI_2Value, FALSE);
	 pc->VariableDefinePlatformVar(NULL, "M_PI_4", &pc->FPType, (UnionAnyValuePointer )&M_PI_4Value, FALSE);
	 pc->VariableDefinePlatformVar(NULL, "M_1_PI", &pc->FPType, (UnionAnyValuePointer )&M_1_PIValue, FALSE);
	 pc->VariableDefinePlatformVar(NULL, "M_2_PI", &pc->FPType, (UnionAnyValuePointer )&M_2_PIValue, FALSE);
	 pc->VariableDefinePlatformVar(NULL, "M_2_SQRTPI", &pc->FPType, (UnionAnyValuePointer )&M_2_SQRTPIValue, FALSE);
	 pc->VariableDefinePlatformVar(NULL, "M_SQRT2", &pc->FPType, (UnionAnyValuePointer )&M_SQRT2Value, FALSE);
	 pc->VariableDefinePlatformVar(NULL, "M_SQRT1_2", &pc->FPType, (UnionAnyValuePointer )&M_SQRT1_2Value, FALSE);
}
